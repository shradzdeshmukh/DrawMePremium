...
public class BitmapDrawView extends View implements View.OnTouchListener, ScrollerDelegate, DrawerDelegate, ScalerDelegate {
    ...
    public BitmapDrawView(Context context, Bitmap bmp) {
        super(context);
        init();
        this.mBitmap = bmp;
    }

    public BitmapDrawView(Context context, AttributeSet attrs, Bitmap bmp) {
        super(context, attrs);
        init();
        this.mBitmap = bmp;
    }
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP) public BitmapDrawView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    @Override protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawBitmap(mBitmap, 1f, 1f, null);
        canvas.save();
...
//        drawGestures(canvas);
    ...
    public Bitmap obtainBitmap() {
        ...
        composeCanvas.drawColor(Color.WHITE); // to make background white
